...
</1&&t.preventdefault()}),n.find("li").css("white-space","nowrap").each(function(){var></8&&(d+=o.ieoffsetx,f+=o.ieoffsety),t.css("left",d+"px").css("top",f+"px").css("opacity","0.01").show();var></this.length;o++)e(this[o]).dropotron(t);return>